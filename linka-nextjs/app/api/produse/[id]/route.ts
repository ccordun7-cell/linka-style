...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const { name, name_ru, product_code, brand_name, price, description, description_ru, category, type, is_barefoot, is_premium, is_sale, sale_price, is_active, sizes, new_images, image_order, deleted_image_ids } = body

  const updatePayload: Record<string, unknown> = {
    name, name_ru, product_code, price, description, description_ru, category, type, is_barefoot, is_premium: !!is_premium, is_active,
